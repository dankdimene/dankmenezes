...
//Criando objeto com essa função
...
//Colocar no terminal: node controladores/clienteControlador.js
...
clienteControlador.buscarUm = function(req,res){
    cliente.findOne({
        ...
        function(erro){
            res.status(500).send(`Erro ao buscar pelo cliente pelo id ${req.params.id} informado: ${erro}`)
        }
    )
}
